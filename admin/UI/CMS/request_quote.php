	   ...
	   //mail function 
		...
		if(count($enquiryData)>0)
		{
			...
			if(trim($_POST["email"])!="")
			{
				...
				$mailArray=array("firstMail"=>'sales@sinelec-tech.com');
		...
		<div class="col-xs-12">
			<div class="box" id="SibsSchool">
				...
				?>
					<div class="row">
						<div class="col-xs-12">
							<form method="post" action="request_quote.php?urlstring=<?php echo EncryptURL('action=Insert')?>" onSubmit="return validation();">
								<div class="row"> 
									<div class="box box-primary">
										<div class="box-body">
											<div class="box-border" style="min-height:800px">
												<div class="col-md-12" style="background-color:#005abb;color:#FFFFFF">
												   <label class="control-label" style="font-size:18px;">Products</label>
												</div>
												<div class="form-group" align="left">
													<div class="col-md-4 col-sm-12 col-xs-12" align="left">
														<label class="control-label">Product Category *</label>
														<select class="form-control" name="product_category_id_1" id="se_1" onChange="getProductByCategoryId(this.value,'1');" required style="width:200px">
													...
													<div class="col-md-4 col-sm-12 col-xs-12" align="left">
														 ...
														 <div id="productDiv_1">
															<select class="form-control" name="product_id" id="product_id_1"  onChange="getProductByDesId(this.value,'1');" required style="width:200px">
													...
													<div class="col-md-4 col-sm-12 col-xs-12" align="left">
														 ...
														 <div>
														  <input size="4" class="form-control" type="number" id="quantity_1" name="quantity_1" min="1" value="<?php echo $fillDataArray['quantity']; ?>" required>
														  <input size="4" type="hidden" id="product_amt_1" name="product_amt_1" value="<?php echo $fillDataArray['product_amt']; ?>">		
														  </div>
													</div>
                                                    <div id="addMore_1"></div>
                                                    <input type="hidden" name="addMore" id="total" value="1" class="form-control select2 input-sm">
                                                </div>
                                                <div class="col-sm-12" style="margin-top:10px;margin-bottom:10px; float:right">
                                                    <button type="button" class="btn btn-danger btn-xs" onClick="javascript:getNextRow()"><i class="glyphicon glyphicon-plus"></i> Add More</button>
                                                    <button type="button" class="btn btn-danger btn-xs" onClick="javascript:removeItem(document.getElementById('total').value)"><i class="glyphicon glyphicon-minus"></i> Remove</button>
                                                </div>
												<div class="col-md-12" style="background-color:#005abb;color:#FFFFFF">
												   <label class="control-label" style="font-size:18px;">Personal Information</label>
												</div>
												<div class="form-group" align="left">
													<div class="col-md-4 col-sm-12 col-xs-12" align="left">
														<label class="control-label">Name *</label>
														<div>
															<input type="text" id="name" name="name" value="<?php echo $fillDataArray['name']; ?>" required>
														</div>
													</div>
													...
													<div class="col-md-4 col-sm-12 col-xs-12" align="left">
														...
														<div>
														<input type="text"id="companyname" name="companyname" value="<?php echo $fillDataArray['companyname']; ?>" required>
														</div>
													</div>
													...
													<div class="col-md-4 col-sm-12 col-xs-12" align="left">
														...
														<div>
														<input type="email" id="email" name="email" value="<?php if($_POST['Email']!='') echo $_POST['Email']; else echo $fillDataArray['email']; ?>" required> 
														</div>
													</div>
													...
													<div class="col-md-4 col-sm-12 col-xs-12" align="left">
														...
														<div>
															<select name="phone_country_code" id="phone_country_code"  style="font-size:12px;text-align:left; width:200px" required>
													...
													<div class="col-md-4 col-sm-12 col-xs-12" align="left">
														...
														<div>
														<input type="text" id="phonenumber" name="phonenumber" maxlength="15" value="<?php echo $fillDataArray['phonenumber']; ?>" required>
														</div>	
													</div>
												</div>	
												...
												<div class="col-md-12" style="background-color:#005abb;color:#FFFFFF">
												   <label class="control-label" style="font-size:18px;">Purchase Details</label>
												</div>
												<div class="form-group" align="left">
													<div class="col-md-4 col-sm-12 col-xs-12" align="left">
														<label class="control-label">Customer Order #</label>
														<div>
														<input type="text" id="customerOrderNo" name="customerOrderNo" value="">
														</div>
													</div>
													...
													<div class="col-md-4 col-sm-12 col-xs-12" align="left">
														...
														<div>
														<input type="text"id="customerSupplierNo" name="customerSupplierNo" value="">
														</div>
													</div>
													...
													<div class="col-md-12 col-sm-12 col-xs-12" align="left">
														...
														<div>
														<textarea name="deliveryaddress" id="deliveryaddress" value="<?php echo $fillDataArray['deliveryaddress'] ?>" required style="width:850px"></textarea>						

														</div>	
													</div>	
														
													<div class="col-md-3 col-sm-12 col-xs-12" align="left">
														<label class="control-label">City/District/Town *</label>
														<div>
													...
													<div class="col-md-3 col-sm-12 col-xs-12" align="left">
														...
														<div>
														<select  type="text"  id="country" onChange="showHideVatNo(this.value)" name="country" required style="width:200px">
												...
												<div class="form-group" align="left">	
													...
													<div class="col-sm-12">
														...
														<div>
														<textarea name="billingAddress" id="billingAddress" value="<?php echo $fillDataArray['example_check1'] ?>" style="width:850px" ></textarea>		
														</div>
													...
													<div class="col-md-3 col-sm-12 col-xs-12" align="left">
														<label class="control-label">City/District/Town</label>
														<div>
														<input  type="text" name="cityName" id="cityName" disabled>
														</div>
													</div>
													<div class="col-md-3 col-sm-12 col-xs-12" align="left">
														<label class="control-label">Province</label>
														<div>
														<input  name="stateName" type="text" id="stateName" disabled>
														</div>
													</div>
													<div class="col-md-3 col-sm-12 col-xs-12" align="left">
														<label class="control-label">ZIP Code</label>
													...
													<div class="col-md-3 col-sm-12 col-xs-12" align="left">
														<label class="control-label">Country</label>
														<div>
														<select  placeholder="Country"  type="text" name="countryName" onChange="showHideVatNo(this.value)"  id="countryName" disabled style="width:200px">
															<option value=''>Select Country</option>
															<?php 
															if(count($countryList)>0)
															{
												...
												<div class="form-group" align="left">
													<div class="col-md-12 col-sm-12 col-xs-12" align="left">
														...
														<label for="example_check1"  style="float:left; font-weight:400">If you are a company situated outside Germany but in EU and want a VAT free quote</label>
												...
												<div class="form-group text-left">
													<div class="col-md-12 col-sm-12 col-xs-12">
														<a href="Enquiry.php"><button   type="button"  class="btn btn-danger" >Cancel</button></a>
				...
				{
					var CategoryIdArray=CategoryId.split('_');
				...
				{
					callAjax("productdescription", "../Ajax/getProductByDesId.php", {
				...
				*/
				...
				{
					var a = Number(r)-1;
					var div_id = "RemoveAddMoreDiv"+r;
					//alert(div_id);
					document.getElementById(div_id).parentNode.removeChild(this.document.getElementById(div_id));
...
ob_end_clean();
$pagetitle = "Manual Request Quote";
