...
if(isset($_POST["send"])){
	...
	$mail->MsgHTML("<b>Hi, your first SMTP mail has been received.<br/>"); //Put your body of the message you can place html code here
...
<title>Send mails using SMTP and PHP in PHP Mailer using our own server or gmail server </title>
