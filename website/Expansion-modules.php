                ...
                <div class="row">
                        ...
                        <div class="carousel slide m-bottom20" data-ride="carousel" id="gallery-post">
							...
							if(count($ProductsDetails)>0)
							{
							 ...
							 ?>
								...
								<img alt="..." class="img-responsive" src="<?php   echo "../admin/UI/Images/ProductImages/".$key."_productImages.".$value['ext']; ?>"></div>
							<?php 
								}
                          ...
                          <div class="m-bottom20 ">
							...
							<input type="hidden" id="productId" name="productId" value="<?php echo $ProductsDetails[0]->PRODUCT_ID; ?>">
                    ...
                    <div class="col-sm-8">
						...
						<div class="description">
							<h2> <?php echo $ProductsDetails[0]->PRODUCT_NAME; ?></h2><br/>
                            ...
                            <tbody>
                                ...
                                <tr>
                                 <td><a href="<?php echo $value['HYPER_LINK']; ?>" target="_blank" >   <?php echo $value['PRODUCT_MANUAL_TITLE']; ?></a></td>
									...
									<td><a href="<?php  if($value['ext']!=NULL) echo "../admin/UI/Images/ProductManuals/".$key."_productManual.".$value['ext']; 
									else  echo $value['HYPER_LINK']; ?>" <?php  if($value['ext']!="") echo 'download='.$value['PRODUCT_MANUAL_TITLE'];?>>Download</a></td>
                                </tr>
                             <?php 
										 }
							 		}
